...
public:
    ...
    bool estConstrcutible(co e) const;
    ...
    co iemeElement (unsigned int indice) const;
    ...
    void modifierIemeElement (unsigned int indice, co e);
    /* Precondition : la liste n'est pas vide, et 0 <= indice < nombre d'éléments
    ...
    void ajouterEnTete (co e);
    /* Postcondition : e est ajouté en tête de liste */

    void ajouterEnQueue (co e);
    ...
    int rechercherElement (co e) const;
    ...
    void insererElement (co e, unsigned int indice);
